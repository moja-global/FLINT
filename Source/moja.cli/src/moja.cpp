...
int main(int argc, char* argv[]) {
   ...
   general_opt.add_options()("help,h", "produce a help message")("help-section", opt::value<std::string>(),
                                                                 "produce a help message for a named section")(
   ...
   cmdLineOptions.add_options()("logging_config", opt::value<std::string>(), "path to Moja logging config file")(
   ...
   configFileOptions.add_options()("config",
                                   opt::value<std::vector<std::string>>()->multitoken()->zero_tokens()->composing(),
   ...
   try {
      ...
      auto config = configProviderPath.empty()
