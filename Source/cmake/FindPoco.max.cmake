...
#
SET(POCO_ROOT $ENV{POCO_ROOT} CACHE PATH "Path to the Poco library root")
...
IF(NOT Poco_INCLUDE_DIR)
    # Fall back to a Poco root set through cmake-gui.
    SET(POCO_ROOT CACHE PATH "Poco root")
    FIND_PATH(Poco_INCLUDE_DIR NAMES Foundation/include/Poco/AbstractCache.h PATHS ${POCO_ROOT})
    SET(POCO_DIR_SEARCH ${POCO_DIR_SEARCH} ${POCO_ROOT})
    SET(SUFFIX_FOR_LIBRARY_PATH ${SUFFIX_FOR_LIBRARY_PATH} bin64 lib64)
ENDIF(NOT Poco_INCLUDE_DIR)
