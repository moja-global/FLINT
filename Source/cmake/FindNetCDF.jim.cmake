...
find_path (NETCDF_INCLUDE_DIR_DEBUG netcdf.h
  PATHS 
	"${NETCDF_DIR}/Debug/include"
	"C:/Development/Software/NetCDF/Debug/include"
)
mark_as_advanced (NETCDF_INCLUDE_DIR_DEBUG)
set (NETCDF_C_INCLUDE_DIRS ${NETCDF_INCLUDE_DIR_DEBUG})

find_path (NETCDF_INCLUDE_DIR_RELEASE netcdf.h
  PATHS 
	"${NETCDF_DIR}/Release/include"
	"C:/Development/Software/NetCDF/Release/include"
)
mark_as_advanced (NETCDF_INCLUDE_DIR_RELEASE)
set (NETCDF_C_INCLUDE_DIRS ${NETCDF_INCLUDE_DIR_RELEASE})
...
macro (NetCDF_check_interface_config lang config header libs)
  if (NETCDF_${lang})
    ...
    #export to internal varS that rest of project can use directly
    set (NETCDF_${lang}_LIBRARIES_${config}    ${NETCDF_${lang}_LIBRARY_${config}})
    set (NETCDF_${lang}_INCLUDE_DIRS_${config} ${NETCDF_${lang}_INCLUDE_DIR_${config}})

    if (NETCDF_${lang}_INCLUDE_DIR_${config} AND NETCDF_${lang}_LIBRARY_${config})
      list (APPEND NetCDF_libs ${NETCDF_${lang}_LIBRARY_${config}})
      list (APPEND NetCDF_includes ${NETCDF_${lang}_INCLUDE_DIR_${config}})
    else ()
      set (NETCDF_HAS_INTERFACES "NO")
      message (STATUS "Failed to find NetCDF interface for ${lang}")
    endif ()
...
NetCDF_check_interface_config (CXX Debug netcdfcpp.h netcdf_c++)
NetCDF_check_interface_config (CXX Release netcdfcpp.h netcdf_c++)
