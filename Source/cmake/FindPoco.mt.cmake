...
# poco-1.6.1-all/bin64
 ...
 #poco-1.6.1-all/lib/Linux/i686
 #poco-1.6.1-all/lib/Linux/x86_64
 #lib
 #lib/Linux/i686
 #lib/Linux/x86_64
)
...
#      ${Poco_INCLUDE_DIR}/Data/PostgreSQL/include
...
#	)
	...
	find_library(Poco_DATA_SQLITE_RELEASE NAMES PocoDataSQLitemt
		PATH_SUFFIXES 
			${SUFFIX_FOR_LIBRARY_PATH} 
		PATHS # Look in other places.
			${Poco_INCLUDE_DIR}
...
#	)
	...
	find_library(Poco_NET_RELEASE NAMES PocoNetmt
		PATH_SUFFIXES 
			${SUFFIX_FOR_LIBRARY_PATH} 
		PATHS # Look in other places.
			${Poco_INCLUDE_DIR}
...
#	)
	...
	find_library(Poco_MONGODB_RELEASE NAMES PocoMongoDBmt
		PATH_SUFFIXES 
			${SUFFIX_FOR_LIBRARY_PATH} 
		PATHS # Look in other places.
			${Poco_INCLUDE_DIR}
...
#	)
	...
	find_library(Poco_DATA_RELEASE NAMES PocoDatamt
		PATH_SUFFIXES 
			${SUFFIX_FOR_LIBRARY_PATH} 
		PATHS # Look in other places.
			${Poco_INCLUDE_DIR}
...
#	)
	...
	find_library(Poco_JSON_RELEASE NAMES PocoJSONmt
		PATH_SUFFIXES 
			${SUFFIX_FOR_LIBRARY_PATH} 
		PATHS # Look in other places.
			${Poco_INCLUDE_DIR}
...
#	)
	...
	find_library(Poco_UTIL_RELEASE NAMES PocoUtilmt
		PATH_SUFFIXES 
			${SUFFIX_FOR_LIBRARY_PATH} 
		PATHS # Look in other places.
			${Poco_INCLUDE_DIR}
	...
	set( Poco_FOUNDATION ${Poco_FOUNDATION_RELEASE} CACHE STRING "Poco Foundation link library text")
	set( Poco_DATA_SQLITE ${Poco_DATA_SQLITE_RELEASE} CACHE STRING "Poco SQLite link library text")
	set( Poco_DATA ${Poco_DATA_RELEASE} CACHE STRING "Poco Data link library text")
	set( Poco_JSON ${Poco_JSON_RELEASE} CACHE STRING "Poco JSON link library text")
	set( Poco_MONGODB ${Poco_MONGODB_RELEASE} CACHE STRING "Poco MONGODB link library text")
	set( Poco_NET ${Poco_NET_RELEASE} CACHE STRING "Poco NET link library text")
	set( Poco_UTIL ${Poco_UTIL_RELEASE} CACHE STRING "Poco Util link library text")
