...
MOCK_BASE_CLASS(MockLandUnitDataWrapper, flint::ILandUnitDataWrapper) {
	...
	MOCK_METHOD(createStockOperation, 1,		std::shared_ptr<flint::IOperation>(moja::DynamicVar&), createStockOperationWithData)
	MOCK_METHOD(createProportionalOperation, 0, std::shared_ptr<flint::IOperation>(),				createProportionalOperation)
	MOCK_METHOD(createProportionalOperation, 1, std::shared_ptr<flint::IOperation>(moja::DynamicVar&), createProportionalOperationWithData)
