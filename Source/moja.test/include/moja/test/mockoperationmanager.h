...
MOCK_BASE_CLASS(MockOperationManager, flint::IOperationManager) {
   ...
   MOCK_METHOD(addPool, 6,
               const flint::IPool*(const std::string&, const std::string&, const std::string&, double, int, double),
               addPool2);
   MOCK_METHOD(addPool, 2, const flint::IPool*(flint::PoolMetaData&, double), addPool3);
   MOCK_METHOD(addPool, 6,
               const flint::IPool*(const std::string&, const std::string&, const std::string&, double, int,
                                   const std::shared_ptr<flint::ITransform>),
               addPool4);
