...
static std::string convertLocalDomainIterationTypeToStr(LocalDomainIterationType type) {
	switch (type) {
		case LocalDomainIterationType::NotAnIteration:			return "NotAnIteration";
		case LocalDomainIterationType::ASpatialIndex:			return "ASpatialIndex";
		case LocalDomainIterationType::ASpatialMongoIndex:		return "ASpatialMongoIndex";
		case LocalDomainIterationType::AreaOfInterest:			return "AreaOfInterest";
		case LocalDomainIterationType::LandscapeTiles:			return "LandscapeTiles";
		case LocalDomainIterationType::TileIndex:				return "TileIndex";
		case LocalDomainIterationType::BlockIndex:				return "BlockIndex";
		case LocalDomainIterationType::CellIndex:				return "CellIndex";
	}
	return "unknown";
}
