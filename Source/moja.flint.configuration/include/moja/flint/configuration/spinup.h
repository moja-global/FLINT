...
public:
	SpinupModule(const std::string& libraryName, const std::string& name, int order, bool createNew, DynamicObject settings);
...
public:
	...
	void addSpinupModule(const std::string& libraryName, const std::string& name, int order, bool createNew = false, DynamicObject settings = moja::DynamicObject());
...
inline std::vector<const Variable*> Spinup::variables() const {
	return copy(_variables);
}

inline std::vector<const ExternalVariable*> Spinup::externalVariables() const {
	return copy(_externalVariables);
}

inline std::vector<const FlintDataVariable*> Spinup::flintDataVariables() const {
	return copy(_flintDataVariables);
}

inline std::vector<const SpinupModule*> Spinup::modules() const {
