...
namespace configuration {
	...
	void Landscape::setIteration(LocalDomainIterationType iterationType)
	{
		...
		//	setIterationXXXXX();
		if (iterationType == LocalDomainIterationType::ASpatialIndex)
			setIterationASpatialIndex();
	...
	void Landscape::setIterationAreaOfInterest()
	{
		_iterationAreaOfInterest = std::make_shared<IterationAreaOfInterest>();
	}

	void Landscape::setIterationASpatialIndex()
	{
		_iterationASpatialIndex = std::make_shared<IterationASpatialIndex>();
	}
	...
	void Landscape::setIterationLandscapeTiles()
	{
		_iterationLandscapeTiles = std::make_shared<IterationLandscapeTiles>();
	}

	void Landscape::setIterationTileIndex()
	{
		_iterationTileIndex = std::make_shared<IterationTileIndex>();
	}

	void Landscape::setIterationBlockIndex() {
		_iterationBlockIndex = std::make_shared<IterationBlockIndex>();
	}

	void Landscape::setIterationCellIndex() {
		_iterationCellIndex = std::make_shared<IterationCellIndex>();
	}
