...
namespace configuration {
	...
	Library::Library(const std::string& path, const std::string& library, const std::string& name, LibraryType type) : _path(path), _library(library), _name(name), _type(type) {
