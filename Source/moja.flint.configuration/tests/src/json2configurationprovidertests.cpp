...
struct Library2ConfigurationTestsFixture {
   ...
   const std::string validLibraries = "        \"moja.modules.sleek\": \"external\"";

   const std::string validLibrariesCBM = "        \"moja.modules.cbm\": \"external\"";
   ...
   const std::string validSpinupDisabled = "        \"enabled\": false";

   const std::string validSpinupVariables = "        \"TestSpinUpVariable\": 1";
   ...
   const std::string validPools = "        \"atmosphere\": 100.0";

   const std::string validPoolsPeastland = "        \"Catotelm_O\": 10.0";
   ...
   const std::string validVariables = "        \"localDomainId\": 1";

   const std::string validVariablesD = "        \"D_variable\": 102.2";
   ...
   const std::string validVariablesArray2 = "        { \"localDomainId\": 1 }";

   const std::string validVariablesArray3 = "        \"localDomainId\"";
   ...
   std::shared_ptr<TemporaryFile> writeConfigFile(const std::string& confTemplate, const std::string& localDomain,
                                                  const std::string& libraries, const std::string& spinup,
                                                  const std::string& spinupModules, const std::string& spinupVariables,
                                                  const std::string& pools, const std::string& variables,
      ...
      configWriter << boost::format(confTemplate) % localDomain % libraries % spinup % spinupModules % spinupVariables %
                          pools % variables % modules;
...
BOOST_AUTO_TEST_CASE(flint_configuration_JSON2ConfigurationProvider_BuildsExpectedModuleConfiguration) {
   ...
   auto configFile =
       writeConfigFile(configTemplate, validLocalDomain, validLibraries, validSpinupDisabled, validSpinupModules,
                       validSpinupVariables, validPools, validVariables, moduleConfig);
...
BOOST_AUTO_TEST_CASE(
   ...
   auto configFile =
       writeConfigFile(configTemplate, validLocalDomain, validLibraries, validSpinupDisabled, validSpinupModules,
                       validSpinupVariables, validPools, variableConfig, validModules);
...
BOOST_AUTO_TEST_CASE(flint_configuration_JSON2ConfigurationProvider_CheckModuleOrderAfterLoadIsSameAsDefinitionInJSON) {
   ...
   auto moduleConfig = "\"" + moduleName[0] +
                       "\" : {\n"
                       "    \"library\": \"moja.modules.sleek\",\n"
                       "    \"order\": 1,\n"
                       "    \"settings\": { }\n"
...
BOOST_AUTO_TEST_CASE(flint_configuration_JSON2ConfigurationProvider_BuildsExpectedConfigurationMergeTwo) {
   ...
   auto configFile1 =
       writeConfigFile(configTemplate, validLocalDomain, validLibrariesCBM, validSpinupDisabled, validSpinupModules,
                       validSpinupVariables, validPoolsPeastland, validVariablesD, validModules);
