...
BOOST_AUTO_TEST_CASE(datarepository_Test_Tile_Iteration) {
	moja::datarepository::ProviderSpatialRasterTiled provider{ std::make_shared<moja::datarepository::FlintRasterReaderFactory>(), moja::DynamicObject(
	{
		{ "type", "raster_tiled" },
		{ "tileLatSize", 1.0 },
		{ "tileLonSize", 1.0 },
	...
	std::vector<moja::Point> tileSet = {
		{ 33.0, -3.0 }, { 34.0, -3.0 }, { 35.0, -3.0 }, { 36.0, -3.0 }, { 37.0, -3.0 }, { 38.0, -3.0 }, { 39.0, -3.0 }, { 40.0, -3.0 }, { 41.0, -3.0 }, { 42.0, -3.0 },
		{ 33.0, -3.0 }, { 34.0, -3.0 }, { 35.0, -3.0 }, { 36.0, -3.0 }, { 37.0, -3.0 }, { 38.0, -3.0 }, { 39.0, -3.0 }, { 40.0, -3.0 }, { 41.0, -3.0 }, { 42.0, -3.0 },
		{ 33.0, -4.0 }, { 34.0, -4.0 }, { 35.0, -4.0 }, { 36.0, -4.0 }, { 37.0, -4.0 }, { 38.0, -4.0 }, { 39.0, -4.0 }, { 40.0, -4.0 }, { 41.0, -4.0 }, { 42.0, -4.0 },
		{ 33.0, -5.0 }, { 34.0, -5.0 }, { 35.0, -5.0 }, { 36.0, -5.0 }, { 37.0, -5.0 }, { 38.0, -5.0 }, { 39.0, -5.0 }, { 40.0, -5.0 }, { 41.0, -5.0 }, { 42.0, -5.0 },
		{ 33.0, -6.0 }, { 34.0, -6.0 }, { 35.0, -6.0 }, { 36.0, -6.0 }, { 37.0, -6.0 }, { 38.0, -6.0 }, { 39.0, -6.0 }, { 40.0, -6.0 }, { 41.0, -6.0 }, { 42.0, -6.0 }
	};
...
BOOST_AUTO_TEST_CASE(datarepository_Test_TileInfoCollection) {
	...
	//int id = 0;
	//for (auto tile : tileSet) {
	//	tileInfoCollection._tilesVec.emplace_back(TileInfo(tileInfoCollection, id++, tile.x, tile.y, 1.0, 1.0, 4000, 4000, 400, 400));
	//}
	...
	//std::cout << std::endl << "End -- DataRepository_Test_TileInfoCollection: cells (" << cellCount << ")" << std::endl;
}
