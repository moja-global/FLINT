...
BOOST_AUTO_TEST_CASE(AspatialTileInfoCollection_ConstructorThrowsExceptionIfMaxTileSizeIsLessThanOne) {
...
BOOST_AUTO_TEST_CASE(AspatialTileInfoCollection_ConstructorThrowsExceptionIfTileCacheSizeIsLessThanOne) {
