...
namespace moja {
	namespace datarepository {
		...
		public:
			TileRasterReaderInterface(const std::string& path, const Point& origin, const std::string& prefix, const TileBlockCellIndexer& indexer, const DynamicObject& settings) :
		...
		public:
			StackRasterReaderInterface(const std::string& path, const Point& origin, const std::string& prefix, const TileBlockCellIndexer& indexer, const DynamicObject& settings) :
				_origin(origin), _indexer(indexer), _settings(settings) {}
		...
		public:
			...
			virtual std::unique_ptr<MetaDataRasterReaderInterface>	getMetaDataRasterReader(const std::string& path, const std::string& prefix, const DynamicObject& settings) const = 0;
			virtual std::unique_ptr<TileRasterReaderInterface>		getTileRasterReader(const std::string& path, const Point& origin, const std::string& prefix, const TileBlockCellIndexer& indexer, const DynamicObject& settings) const = 0;
			virtual std::unique_ptr<StackRasterReaderInterface>		getStackRasterReader(const std::string& path, const Point& origin, const std::string& prefix, const TileBlockCellIndexer& indexer, const DynamicObject& settings) const = 0;
		};
