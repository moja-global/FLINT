...
inline AspatialTileInfoCollection::iterator AspatialTileInfoCollection::begin() { return iterator(*this); }

inline AspatialTileInfoCollection::iterator AspatialTileInfoCollection::end() { return iterator(*this, false); }
...
AspatialTileInfoCollection::_iterator<is_const_iterator>::_iterator(
    const AspatialTileInfoCollection& tileInfoCollection, bool start)
...
template <bool is_const_iterator>
inline typename AspatialTileInfoCollection::_iterator<is_const_iterator>::self_type&
AspatialTileInfoCollection::_iterator<is_const_iterator>::operator++() {
   increment();
   return *this;
}
...
template <bool is_const_iterator>
inline typename AspatialTileInfoCollection::_iterator<is_const_iterator>::self_type
AspatialTileInfoCollection::_iterator<is_const_iterator>::operator++(int) {
...
template <bool is_const_iterator>
inline typename AspatialTileInfoCollection::_iterator<is_const_iterator>::ValueReferenceType
    AspatialTileInfoCollection::_iterator<is_const_iterator>::operator*() {
   return *_currentTileIter;
}

template <bool is_const_iterator>
inline typename AspatialTileInfoCollection::_iterator<is_const_iterator>::ValuePointerType
    AspatialTileInfoCollection::_iterator<is_const_iterator>::operator->() {
   return &(*_currentTileIter);
}
