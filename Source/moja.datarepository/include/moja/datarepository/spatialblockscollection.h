...
public:
	...
	private:
		...
		unsigned _tileTop;		unsigned _blockTop;
		unsigned _tileLeft;		unsigned _blockLeft;
		unsigned _tileRight;	unsigned _blockRight;
		unsigned _tileBottom;	unsigned _blockBottom;
	};

	typedef _iterator<false> iterator;
	typedef _iterator<true> const_iterator;

	explicit SpatialBlocksCollection(const TileBlockCellIndexer& indexer) :_indexer(indexer), _tileIdx(0, indexer), _hasAreaOfInterest(false), _hasTileIdx(false) {}
	SpatialBlocksCollection(Rectangle& areaOfInterest, const TileBlockCellIndexer& indexer) :_indexer(indexer), _tileIdx(0, indexer), _areaOfInterest(areaOfInterest), _hasAreaOfInterest(true), _hasTileIdx(false) {}
	SpatialBlocksCollection(const TileIdx& tileIdx, const TileBlockCellIndexer& indexer) :_indexer(indexer), _tileIdx(tileIdx), _hasAreaOfInterest(false), _hasTileIdx(true) {}
...
inline SpatialBlocksCollection::iterator SpatialBlocksCollection::end() {
...
template <bool is_const_iterator>
SpatialBlocksCollection::_iterator<is_const_iterator>::_iterator(const Rectangle& areaOfInterest, const TileBlockCellIndexer& indexer) :
...
template <bool is_const_iterator>
SpatialBlocksCollection::_iterator<is_const_iterator>::_iterator(const TileIdx& tileIdx, const TileBlockCellIndexer& indexer) :
...
template <bool is_const_iterator>
inline typename SpatialBlocksCollection::_iterator<is_const_iterator>::self_type& SpatialBlocksCollection::_iterator<is_const_iterator>::operator++() {
	increment();
	return *this;
}

template <bool is_const_iterator>
inline typename SpatialBlocksCollection::_iterator<is_const_iterator>::self_type SpatialBlocksCollection::_iterator<is_const_iterator>::operator++(int) {
...
template <bool is_const_iterator>
inline typename SpatialBlocksCollection::_iterator<is_const_iterator>::ValueReferenceType SpatialBlocksCollection::_iterator<is_const_iterator>::operator*() { return _block; }

template <bool is_const_iterator>
inline typename SpatialBlocksCollection::_iterator<is_const_iterator>::ValuePointerType SpatialBlocksCollection::_iterator<is_const_iterator>::operator->() { return &_block; }

template <bool is_const_iterator>
inline bool SpatialBlocksCollection::_iterator<is_const_iterator>::operator==(const self_type& rhs) {
	return (_block.blockIdx == rhs._block.blockIdx
		&& _block.tileIdx == rhs._block.tileIdx);
}

template <bool is_const_iterator>
inline bool SpatialBlocksCollection::_iterator<is_const_iterator>::operator!=(const self_type& rhs) { return !(*this == rhs); }
...
void SpatialBlocksCollection::_iterator<is_const_iterator>::increment() {
	...
	if (!_hasAreaOfInterest && !_hasTileIdx)
		return;
