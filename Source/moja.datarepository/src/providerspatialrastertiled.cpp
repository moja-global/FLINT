...
ProviderSpatialRasterTiled::ProviderSpatialRasterTiled(
    std::shared_ptr<RasterReaderFactoryInterface> rasterReaderFactory, DynamicObject settings) {
   ...
   _indexer = std::make_unique<TileBlockCellIndexer>(tileLatSize, tileLonSize, blockLatSize, blockLonSize, cellLatSize,
                                                     cellLonSize);
   ...
   for (auto& l : layers) {
      ...
      if (layerType == "GridLayer") {
         ...
         if (layerData == "UInt8" || layerData == "Byte") {
            _layers.insert(std::make_pair(
                layerName, std::make_shared<GridLayer<UInt8>>(
                               rasterReaderFactory, layerName, layerPath, layerPrefix, *_indexer,
                               TileBlockCellIndexer(layertileLatSize, layertileLonSize, layerblockLatSize,
                                                    layerblockLonSize, layercellLatSize, layercellLonSize),
                               layer["nodata"], layer, attributeTable)));
         } else if (layerData == "UInt16") {
            _layers.insert(std::make_pair(
                layerName, std::make_shared<GridLayer<UInt16>>(
                               rasterReaderFactory, layerName, layerPath, layerPrefix, *_indexer,
                               TileBlockCellIndexer(layertileLatSize, layertileLonSize, layerblockLatSize,
                                                    layerblockLonSize, layercellLatSize, layercellLonSize),
                               layer["nodata"], layer, attributeTable)));
            ...
            _layers.insert(std::make_pair(
                layerName, std::make_shared<GridLayer<Int16>>(
                               rasterReaderFactory, layerName, layerPath, layerPrefix, *_indexer,
                               TileBlockCellIndexer(layertileLatSize, layertileLonSize, layerblockLatSize,
                                                    layerblockLonSize, layercellLatSize, layercellLonSize),
                               layer["nodata"], layer, attributeTable)));
            ...
            _layers.insert(std::make_pair(
                layerName, std::make_shared<GridLayer<Int32>>(
                               rasterReaderFactory, layerName, layerPath, layerPrefix, *_indexer,
                               TileBlockCellIndexer(layertileLatSize, layertileLonSize, layerblockLatSize,
                                                    layerblockLonSize, layercellLatSize, layercellLonSize),
                               layer["nodata"], layer, attributeTable)));
            ...
            _layers.insert(std::make_pair(
                layerName, std::make_shared<GridLayer<UInt32>>(
                               rasterReaderFactory, layerName, layerPath, layerPrefix, *_indexer,
                               TileBlockCellIndexer(layertileLatSize, layertileLonSize, layerblockLatSize,
                                                    layerblockLonSize, layercellLatSize, layercellLonSize),
                               layer["nodata"], layer, attributeTable)));
            ...
            _layers.insert(std::make_pair(
                layerName, std::make_shared<GridLayer<float>>(
                               rasterReaderFactory, layerName, layerPath, layerPrefix, *_indexer,
                               TileBlockCellIndexer(layertileLatSize, layertileLonSize, layerblockLatSize,
                                                    layerblockLonSize, layercellLatSize, layercellLonSize),
                               layer["nodata"], layer, attributeTable)));
         ...
         if (layerData == "UInt8" || layerData == "Byte") {
            _layers.insert(std::make_pair(
                layerName, std::make_shared<StackLayer<UInt8>>(
                               rasterReaderFactory, layerName, layerPath, layerPrefix, nLayers, *_indexer,
                               TileBlockCellIndexer(layertileLatSize, layertileLonSize, layerblockLatSize,
                                                    layerblockLonSize, layercellLatSize, layercellLonSize),
                               layer["nodata"], layer)));
         } else if (layerData == "UInt16") {
            _layers.insert(std::make_pair(
                layerName, std::make_shared<StackLayer<UInt16>>(
                               rasterReaderFactory, layerName, layerPath, layerPrefix, nLayers, *_indexer,
                               TileBlockCellIndexer(layertileLatSize, layertileLonSize, layerblockLatSize,
                                                    layerblockLonSize, layercellLatSize, layercellLonSize),
                               layer["nodata"], layer)));
            ...
            _layers.insert(std::make_pair(
                layerName, std::make_shared<StackLayer<Int16>>(
                               rasterReaderFactory, layerName, layerPath, layerPrefix, nLayers, *_indexer,
                               TileBlockCellIndexer(layertileLatSize, layertileLonSize, layerblockLatSize,
                                                    layerblockLonSize, layercellLatSize, layercellLonSize),
                               layer["nodata"], layer)));
            ...
            _layers.insert(std::make_pair(
                layerName, std::make_shared<StackLayer<Int32>>(
                               rasterReaderFactory, layerName, layerPath, layerPrefix, nLayers, *_indexer,
                               TileBlockCellIndexer(layertileLatSize, layertileLonSize, layerblockLatSize,
                                                    layerblockLonSize, layercellLatSize, layercellLonSize),
                               layer["nodata"], layer)));
            ...
            _layers.insert(std::make_pair(
                layerName, std::make_shared<StackLayer<UInt32>>(
                               rasterReaderFactory, layerName, layerPath, layerPrefix, nLayers, *_indexer,
                               TileBlockCellIndexer(layertileLatSize, layertileLonSize, layerblockLatSize,
                                                    layerblockLonSize, layercellLatSize, layercellLonSize),
                               layer["nodata"], layer)));
            ...
            _layers.insert(std::make_pair(
                layerName, std::make_shared<StackLayer<float>>(
                               rasterReaderFactory, layerName, layerPath, layerPrefix, nLayers, *_indexer,
                               TileBlockCellIndexer(layertileLatSize, layertileLonSize, layerblockLatSize,
                                                    layerblockLonSize, layercellLatSize, layercellLonSize),
                               layer["nodata"], layer)));
...
CellIdx ProviderSpatialRasterTiled::getLayerCellIdx(const std::string& name, UInt32 tileIdx, UInt32 blockIdx,
                                                    UInt32 cellIdx) const {
   auto layer = _layers.at(name);
