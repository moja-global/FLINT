...
BOOST_AUTO_TEST_CASE(core_datetime_DaysInYear) {
    BOOST_CHECK_EQUAL(DateTime::daysInYear(1970), 365);
}

BOOST_AUTO_TEST_CASE(core_datetime_DaysInYear_Leap) {
    BOOST_CHECK_EQUAL(DateTime::daysInYear(1972), 366);
}
