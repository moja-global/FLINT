...
CORE_API void die_with_message(const std::string& msg);

//! die with message - either throw an exception or die via std::terminate()
CORE_API void die_with_message(const char* msg, const char* file, size_t line);

//! die with message - either throw an exception or die via std::terminate()
CORE_API void die_with_message(const std::string& msg, const char* file, size_t line);
