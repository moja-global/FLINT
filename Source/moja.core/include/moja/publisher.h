...
public:
	TimingInitMessage(DateTime startDate, int nSteps, int startYear, int startStep,
		              int endYear, int endStep, int stepsPerYr) :
...
public:
	TimingStepStartMessage(int step, int numberOfSteps, double stepLengthInYears,
		                   DateTime stepTime, DateTime startDate, DateTime endDate) :
		_step(step), _numberOfSteps(numberOfSteps), _stepLengthInYears(stepLengthInYears),
		_startDate(startDate), _endDate(endDate), _stepTime(stepTime) {}
...
public:
	TimingStepEndMessage(int step, int numberOfSteps, double stepLengthInYears, DateTime stepTime,
