...
Poco::MongoDB::Array::Ptr parsePocoJSONToMongoDBObj(Poco::JSON::Array::Ptr& val) {
	...
	for (auto i = 0; i < count; i++) {
		...
		if (val->isObject(i)) {
			...
			if (object.isArray()) {
				auto msg = (boost::format("Unhandled data type in parse of json into poco::mongodb::document - Array")).str();
				...
				auto msg = (boost::format("Unhandled data type in parse of json into poco::mongodb::document - Deque")).str();
				BOOST_THROW_EXCEPTION(datarepository::AssertionViolationException() << moja::datarepository::AssertMsg(msg));
			}
				...
				auto msg = (boost::format("Unhandled data type in parse of json into poco::mongodb::document - List")).str();
				BOOST_THROW_EXCEPTION(datarepository::AssertionViolationException() << moja::datarepository::AssertMsg(msg));
			}
				...
				auto msg = (boost::format("Unhandled data type in parse of json into poco::mongodb::document - Signed")).str();
				BOOST_THROW_EXCEPTION(datarepository::AssertionViolationException() << moja::datarepository::AssertMsg(msg));
			}
				...
				auto msg = (boost::format("Unhandled data type in parse of json into poco::mongodb::document - Struct")).str();
				BOOST_THROW_EXCEPTION(datarepository::AssertionViolationException() << moja::datarepository::AssertMsg(msg));
			}
			else if (object.isVector()) {
				auto msg = (boost::format("Unhandled data type in parse of json into poco::mongodb::document - Vector")).str();
				BOOST_THROW_EXCEPTION(datarepository::AssertionViolationException() << moja::datarepository::AssertMsg(msg));
			}
			else {
				auto msg = (boost::format("Unhandled data type in parse of json into poco::mongodb::document - Unexpected type")).str();
				BOOST_THROW_EXCEPTION(datarepository::AssertionViolationException() << moja::datarepository::AssertMsg(msg));
			}
		}
	}
