...
NoSQLCollectionTransform::NoSQLCollectionTransform() : _landUnitController(nullptr), _dataRepository(nullptr), _keyVariable(nullptr) {}

void NoSQLCollectionTransform::configure(DynamicObject config, const flint::ILandUnitController& landUnitController, moja::datarepository::DataRepository& dataRepository) {
	_config = config;
