...
// --------------------------------------------------------------------------------------------
// the ResultFluxIterator - or the OperationResult doesn't guarantee that transfers from the same source and to the same sink will be combined.
// This means that checking the count won't be consistent across tests that have multiple transfers added to same source/sink combinations.
...
void test_Kahan_summation_issues_Proportion(mf::IOperationManager& manager, mf::IModule& module) {
	...
	std::vector<PoolInitValueAndResult> data = {
		{ "A",	21.440093961169907,	0.0 },
		{ "B",	0.0,	10.7200469805849535 },
		{ "C",	0.0,	10.7200469805849535 }
	};
	for (auto& p : data) {
		p.poolHandle = manager.addPool(p.name, p.value);
	}
...
void test_PerformanceTestProportionalSLEEK(mf::IOperationManager& manager, mf::IModule& module) {
	...
	std::vector<PoolInitValueAndResult> data = {
		{ "A1",	100.0,  66.66666691607 },
		{ "A2", 100.0, 133.33333308393 },
		{ "A3", 100.0,  66.66666691607 },
		{ "A4", 100.0, 133.33333308393 },
		{ "B1",	100.0,  66.66666691607 },
		{ "B2", 100.0, 133.33333308393 },
		{ "B3", 100.0,  66.66666691607 },
		{ "B4", 100.0, 133.33333308393 },
		{ "C1",	100.0,  66.66666691607 },
		{ "C2", 100.0, 133.33333308393 },
		{ "C3", 100.0,  66.66666691607 },
		{ "C4", 100.0, 133.33333308393 },
		{ "D1",	150.0, 100.00000037410 },
		{ "D2", 150.0, 199.99999962590 },
		{ "D3", 150.0, 100.00000037410 },
		{ "D4", 150.0, 199.99999962590 },
		{ "E1",	100.0,  66.66666691607 },
		{ "E2", 100.0, 133.33333308393 },
		{ "E3", 100.0,  66.66666691607 },
		{ "E4", 100.0, 133.33333308393 },
		{ "F1",	100.0,  66.66666691607 },
		{ "F2", 100.0, 133.33333308393 },
		{ "F3", 100.0,  66.66666691607 },
		{ "F4", 100.0, 133.33333308393 },
		{ "G1",	100.0,  66.66666691607 },
		{ "G2", 100.0, 133.33333308393 },
		{ "G3", 100.0,  66.66666691607 },
		{ "G4", 100.0, 133.33333308393 },
		{ "H1",	100.0,  66.66666691607 },
		{ "H2", 100.0, 133.33333308393 },
		{ "H3", 100.0,  66.66666691607 },
		{ "H4", 100.0, 133.33333308393 },
		{ "I1",	100.0,  66.66666691607 },
		{ "I2", 100.0, 133.33333308393 },
		{ "I3", 100.0,  66.66666691607 },
		{ "I4", 100.0, 133.33333308393 },
		{ "J1",	100.0,  66.66666691607 },
		{ "J2", 100.0, 133.33333308393 },
		{ "J3", 100.0,  66.66666691607 },
	...
	std::vector<PoolInitValueAndResult> data = {
		{ "A1",	100.0,  66.6666666667 },
		{ "A2", 100.0, 133.333333333  },
		{ "A3", 100.0,  66.6666666667 },
		{ "A4", 100.0, 133.333333333  },
		{ "B1",	100.0,  66.6666666667 },
		{ "B2", 100.0, 133.333333333  },
		{ "B3", 100.0,  66.6666666667 },
		{ "B4", 100.0, 133.333333333  },
		{ "C1",	100.0,  66.6666666667 },
		{ "C2", 100.0, 133.333333333  },
		{ "C3", 100.0,  66.6666666667 },
		{ "C4", 100.0, 133.333333333  },
		{ "D1",	150.0, 100.0000000000 },
		{ "D2", 150.0, 200.0000000000 },
		{ "D3", 150.0, 100.0000000000 },
		{ "D4", 150.0, 200.0000000000 },
		{ "E1",	100.0,  66.6666666667 },
		{ "E2", 100.0, 133.333333333  },
		{ "E3", 100.0,  66.6666666667 },
		{ "E4", 100.0, 133.333333333  },
		{ "F1",	100.0,  66.6666666667 },
		{ "F2", 100.0, 133.333333333  },
		{ "F3", 100.0,  66.6666666667 },
		{ "F4", 100.0, 133.333333333  },
		{ "G1",	100.0,  66.6666666667 },
		{ "G2", 100.0, 133.333333333  },
		{ "G3", 100.0,  66.6666666667 },
		{ "G4", 100.0, 133.333333333  },
		{ "H1",	100.0,  66.6666666667 },
		{ "H2", 100.0, 133.333333333  },
		{ "H3", 100.0,  66.6666666667 },
		{ "H4", 100.0, 133.333333333  },
		{ "I1",	100.0,  66.6666666667 },
		{ "I2", 100.0, 133.333333333  },
		{ "I3", 100.0,  66.6666666667 },
		{ "I4", 100.0, 133.333333333  },
		{ "J1",	100.0,  66.6666666667 },
		{ "J2", 100.0, 133.333333333  },
		{ "J3", 100.0,  66.6666666667 },
	...
	for (auto x = 0; x < TEST_LOOPS; x++) {
		for (auto step = 0; step < TEST_STEPS; step++) {
			...
			//		std::cout << "type: " << OperationTransferTypeToString(flux->transferType()) << ", src: " << flux->source() << ", snk: " << flux->sink() << ", val: " << flux->value() << std::endl;
			//	}
			//}
			//std::cout << std::endl;
	...
	std::cout << std::setw(40) << std::setfill(' ') << testSuiteName << ": " << std::setw(50) << std::setfill(' ') << testName << ": Milliseconds : " << length.totalMilliseconds() << std::endl;
	//std::cout << std::setw(40) << std::setfill(' ') << testSuiteName << ": " << std::setw(40) << std::setfill(' ') << testName << ": operations   : " << operations << std::endl;
	//std::cout << std::setw(40) << std::setfill(' ') << testSuiteName << ": " << std::setw(40) << std::setfill(' ') << testName << ": applys       : " << applys << std::endl;
	//std::cout << std::setw(40) << std::setfill(' ') << testSuiteName << ": " << std::setw(40) << std::setfill(' ') << testName << ": transfers    : " << transfers << std::endl;

	//std::cout << std::setw(40) << std::setfill(' ') << testSuiteName << ": " << std::setw(50) << std::setfill(' ') << testName << ": Pool ending values:" << std::endl;
	//for (auto pool : manager.poolCollection()) {
	//	std::cout << pool->name() << " = " << std::setprecision(12) << pool->value() << std::endl;
	//}
	//std::cout << std::endl;
...
void test_PerformanceTestStockSLEEK(mf::IOperationManager& manager, mf::IModule& module) {
	...
	std::vector<PoolInitValueAndResult> data = {
		{ "A1",	10000000.0,  9999998.800000 },
		{ "A2", 15000000.0, 15000001.200000 },
		{ "A3", 10000000.0,  9999998.800000 },
		{ "A4", 15000000.0, 15000001.200000 },
		{ "B1",	10000000.0,  9999998.800000 },
		{ "B2", 15000000.0, 15000001.200000 },
		{ "B3", 10000000.0,  9999998.800000 },
		{ "B4", 15000000.0, 15000001.200000 },
		{ "C1",	10000000.0,  9999998.800000 },
		{ "C2", 15000000.0, 15000001.200000 },
		{ "C3", 10000000.0,  9999998.800000 },
		{ "C4", 15000000.0, 15000001.200000 },
		{ "D1",	10000000.0,  9999998.800000 },
		{ "D2", 15000000.0, 15000001.200000 },
		{ "J3", 10000000.0,   9999700.000000000 },
		{ "J4", 15000000.0,  15000300.000000000 }
	};
#else	// 10000 loops
	...
	std::vector<PoolInitValueAndResult> data = {
		{ "A1",	10000000.0,   9970000.000000000 },
		{ "A2", 15000000.0,  15030000.000000000 },
		{ "A3", 10000000.0,   9970000.000000000 },
		{ "A4", 15000000.0,  15030000.000000000 },
		{ "B1",	10000000.0,   9970000.000000000 },
		{ "B2", 15000000.0,  15030000.000000000 },
		{ "B3", 10000000.0,   9970000.000000000 },
		{ "B4", 15000000.0,  15030000.000000000 },
		{ "C1",	10000000.0,   9970000.000000000 },
		{ "C2", 15000000.0,  15030000.000000000 },
		{ "C3", 10000000.0,   9970000.000000000 },
		{ "C4", 15000000.0,  15030000.000000000 },
		{ "D1",	10000000.0,   9970000.000000000 },
		{ "D2", 15000000.0,  15030000.000000000 },
		{ "D3", 10000000.0,   9970000.000000000 },
		{ "D4", 15000000.0,  15030000.000000000 },
		{ "E1",	10000000.0,   9970000.000000000 },
		{ "E2", 15000000.0,  15030000.000000000 },
		{ "E3", 10000000.0,   9970000.000000000 },
		{ "E4", 15000000.0,  15030000.000000000 },
		{ "F1",	10000000.0,   9970000.000000000 },
		{ "F2", 15000000.0,  15030000.000000000 },
		{ "F3", 10000000.0,   9970000.000000000 },
		{ "F4", 15000000.0,  15030000.000000000 },
		{ "G1",	10000000.0,   9970000.000000000 },
		{ "G2", 15000000.0,  15030000.000000000 },
		{ "G3", 10000000.0,   9970000.000000000 },
		{ "G4", 15000000.0,  15030000.000000000 },
		{ "H1",	10000000.0,   9970000.000000000 },
		{ "H2", 15000000.0,  15030000.000000000 },
		{ "H3", 10000000.0,   9970000.000000000 },
		{ "H4", 15000000.0,  15030000.000000000 },
		{ "I1",	10000000.0,   9970000.000000000 },
		{ "I2", 15000000.0,  15030000.000000000 },
		{ "I3", 10000000.0,   9970000.000000000 },
		{ "I4", 15000000.0,  15030000.000000000 },
		{ "J1",	10000000.0,   9970000.000000000 },
		{ "J2", 15000000.0,  15030000.000000000 },
		{ "J3", 10000000.0,   9970000.000000000 },
		{ "J4", 15000000.0,  15030000.000000000 }
	};
#endif
#endif
	for (auto& p : data) {
	...
	for (auto& p : data) {
		...
		//std::cout << "Pool: " << std::setprecision(15) << p.poolHandle->value() << ", Result: " << std::setprecision(15) << p.result << ", diff: " << std::setprecision(15) << abs(p.poolHandle->value() - p.result) << std::endl;
	}
	data.clear();
...
void test_PerformanceTestCBM(mf::IOperationManager& manager, mf::IModule& module) {
	...
	std::vector<PoolInitValueAndResult> data = {
		{ "A1",	100.0, 66.8896325746 },
		{ "A2", 100.0, 133.110367425 },
		{ "A3", 100.0, 66.8896325746 },
		{ "A4", 100.0, 133.110367425 },
		{ "B1",	100.0, 66.8896325746 },
		{ "B2", 100.0, 133.110367425 },
		{ "B3", 100.0, 66.8896325746 },
		{ "B4", 100.0, 133.110367425 },
		{ "C1",	100.0, 66.8896325746 },
		{ "C2", 100.0, 133.110367425 },
		{ "C3", 100.0, 66.8896325746 },
		{ "C4", 100.0, 133.110367425 },
		{ "D1",	150.0, 100.334448862 },
		{ "D2", 150.0, 199.665551138 },
		{ "D3", 150.0, 100.334448862 },
		{ "D4", 150.0, 199.665551138 },
		{ "E1",	100.0, 66.8896325746 },
		{ "E2", 100.0, 133.110367425 },
		{ "E3", 100.0, 66.8896325746 },
		{ "E4", 100.0, 133.110367425 },
		{ "F1",	100.0, 66.8896325746 },
		{ "F2", 100.0, 133.110367425 },
		{ "F3", 100.0, 66.8896325746 },
		{ "F4", 100.0, 133.110367425 },
		{ "G1",	100.0, 66.8896325746 },
		{ "G2", 100.0, 133.110367425 },
		{ "G3", 100.0, 66.8896325746 },
		{ "G4", 100.0, 133.110367425 },
		{ "H1",	100.0, 66.8896325746 },
		{ "H2", 100.0, 133.110367425 },
		{ "H3", 100.0, 66.8896325746 },
		{ "H4", 100.0, 133.110367425 },
		{ "I1",	100.0, 66.8896325746 },
		{ "I2", 100.0, 133.110367425 },
		{ "I3", 100.0, 66.8896325746 },
		{ "I4", 100.0, 133.110367425 },
		{ "J1",	100.0, 66.8896325746 },
		{ "J2", 100.0, 133.110367425 },
		{ "J3", 100.0, 66.8896325746 },
	...
	std::vector<PoolInitValueAndResult> data = {
		{ "A1",	100.0,  66.889632107 },
		{ "A2", 100.0, 133.110367893 },
		{ "A3", 100.0,  66.889632107 },
		{ "A4", 100.0, 133.110367893 },
		{ "B1",	100.0,  66.889632107 },
		{ "B2", 100.0, 133.110367893 },
		{ "B3", 100.0,  66.889632107 },
		{ "B4", 100.0, 133.110367893 },
		{ "C1",	100.0,  66.889632107 },
		{ "C2", 100.0, 133.110367893 },
		{ "C3", 100.0,  66.889632107 },
		{ "C4", 100.0, 133.110367893 },
		{ "D1",	150.0, 100.334448161 },
		{ "D2", 150.0, 199.665551839 },
		{ "D3", 150.0, 100.334448161 },
		{ "D4", 150.0, 199.665551839 },
		{ "E1",	100.0,  66.889632107 },
		{ "E2", 100.0, 133.110367893 },
		{ "E3", 100.0,  66.889632107 },
		{ "E4", 100.0, 133.110367893 },
		{ "F1",	100.0,  66.889632107 },
		{ "F2", 100.0, 133.110367893 },
		{ "F3", 100.0,  66.889632107 },
		{ "F4", 100.0, 133.110367893 },
		{ "G1",	100.0,  66.889632107 },
		{ "G2", 100.0, 133.110367893 },
		{ "G3", 100.0,  66.889632107 },
		{ "G4", 100.0, 133.110367893 },
		{ "H1",	100.0,  66.889632107 },
		{ "H2", 100.0, 133.110367893 },
		{ "H3", 100.0,  66.889632107 },
		{ "H4", 100.0, 133.110367893 },
		{ "I1",	100.0,  66.889632107 },
		{ "I2", 100.0, 133.110367893 },
		{ "I3", 100.0,  66.889632107 },
		{ "I4", 100.0, 133.110367893 },
		{ "J1",	100.0,  66.889632107 },
		{ "J2", 100.0, 133.110367893 },
		{ "J3", 100.0,  66.889632107 },
...
void ApplyOperationsCorrectlyUpdatesPoolsForSimpleCase(mf::IOperationManager& manager, mf::IModule& module) {
	...
	double amountToMove = 40.0;
	std::vector<PoolInitValueAndResult> data = {
		{ "A",	p1InitialValue,	(p1InitialValue - amountToMove) },
