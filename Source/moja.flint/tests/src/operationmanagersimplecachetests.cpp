...
// --------------------------------------------------------------------------------------------
BOOST_AUTO_TEST_CASE(SimpleCache_NoPoolIteration) {
	test_NoPoolIteration(manager, module);
}

// --------------------------------------------------------------------------------------------
BOOST_AUTO_TEST_CASE(SimpleCache_SinglePoolIteration) {
	test_SinglePoolIteration(manager, module);
}

// --------------------------------------------------------------------------------------------
BOOST_AUTO_TEST_CASE(SimpleCache_MultiplePoolIteration) {
	test_MultiplePoolIteration(manager, module);
}

// --------------------------------------------------------------------------------------------
BOOST_AUTO_TEST_CASE(SimpleCache_NoResultIteration) {
	test_NoResultIteration(manager, module);
}

// --------------------------------------------------------------------------------------------
BOOST_AUTO_TEST_CASE(SimpleCache_SingleResultIteration) {
	test_SingleResultIteration(manager, module);
}

// --------------------------------------------------------------------------------------------
BOOST_AUTO_TEST_CASE(SimpleCache_MultipleResultIteration) {
	test_MultipleResultIteration(manager, module);
}

// --------------------------------------------------------------------------------------------
BOOST_AUTO_TEST_CASE(SimpleCache_NoResultFluxIteration) {
	test_NoResultFluxIteration(manager, module);
}

// --------------------------------------------------------------------------------------------
BOOST_AUTO_TEST_CASE(SimpleCache_SingleResultFluxIteration) {
	test_SingleResultFluxIteration(manager, module);
}

// --------------------------------------------------------------------------------------------
BOOST_AUTO_TEST_CASE(SimpleCache_MultipleResultFluxIteration) {
	test_MultipleResultFluxIteration(manager, module);
}

// --------------------------------------------------------------------------------------------
BOOST_AUTO_TEST_CASE(SimpleCache_SingleProportionTransfer) {
	test_SingleProportionTransfer(manager,module);
}

// --------------------------------------------------------------------------------------------
BOOST_AUTO_TEST_CASE(SimpleCache_SingleStockTransfer) {
	test_SingleStockTransfer(manager, module);
}

// --------------------------------------------------------------------------------------------
BOOST_AUTO_TEST_CASE(SimpleCache_DoubleProportionalTransfer) {
	test_DoubleProportionalTransfer(manager, module);
}

// --------------------------------------------------------------------------------------------
BOOST_AUTO_TEST_CASE(SimpleCache_DoubleStockTransfer) {
	test_DoubleStockTransfer(manager, module);
}

// --------------------------------------------------------------------------------------------
BOOST_AUTO_TEST_CASE(SimpleCache_DoubleStockAndApplyTransfer) {
...
// --------------------------------------------------------------------------------------------
BOOST_AUTO_TEST_CASE(SimpleCache_PerformanceTestStockSLEEK) {
	test_PerformanceTestStockSLEEK(manager, module);
}

// --------------------------------------------------------------------------------------------
BOOST_AUTO_TEST_CASE(SimpleCache_PerformanceTestCBM) {
