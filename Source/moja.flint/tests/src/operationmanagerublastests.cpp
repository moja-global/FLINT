...
// --------------------------------------------------------------------------------------------
BOOST_AUTO_TEST_CASE(Ublas_NoPoolIteration) {
	test_NoPoolIteration(manager, module);
}

// --------------------------------------------------------------------------------------------
BOOST_AUTO_TEST_CASE(Ublas_SinglePoolIteration) {
	test_SinglePoolIteration(manager, module);
}

// --------------------------------------------------------------------------------------------
BOOST_AUTO_TEST_CASE(Ublas_MultiplePoolIteration) {
	test_MultiplePoolIteration(manager, module);
}

// --------------------------------------------------------------------------------------------
BOOST_AUTO_TEST_CASE(Ublas_NoResultIteration) {
	test_NoResultIteration(manager, module);
}

// --------------------------------------------------------------------------------------------
BOOST_AUTO_TEST_CASE(Ublas_SingleResultIteration) {
	test_SingleResultIteration(manager, module);
}

// --------------------------------------------------------------------------------------------
BOOST_AUTO_TEST_CASE(Ublas_MultipleResultIteration) {
	test_MultipleResultIteration(manager, module);
}

// --------------------------------------------------------------------------------------------
BOOST_AUTO_TEST_CASE(Ublas_NoResultFluxIteration) {
	test_NoResultFluxIteration(manager, module);
}

// --------------------------------------------------------------------------------------------
BOOST_AUTO_TEST_CASE(Ublas_SingleResultFluxIteration) {
	test_SingleResultFluxIteration(manager, module);
}

// --------------------------------------------------------------------------------------------
BOOST_AUTO_TEST_CASE(Ublas_MultipleResultFluxIteration) {
	test_MultipleResultFluxIteration(manager, module);
}

// --------------------------------------------------------------------------------------------
BOOST_AUTO_TEST_CASE(Ublas_SingleProportionTransfer) {
	test_SingleProportionTransfer(manager, module);
}

// --------------------------------------------------------------------------------------------
BOOST_AUTO_TEST_CASE(Ublas_SingleStockTransfer) {
	test_SingleStockTransfer(manager, module);
}

// --------------------------------------------------------------------------------------------
BOOST_AUTO_TEST_CASE(Ublas_DoubleProportionalTransfer) {
	test_DoubleProportionalTransfer(manager, module);
}

// --------------------------------------------------------------------------------------------
BOOST_AUTO_TEST_CASE(Ublas_DoubleStockTransfer) {
	test_DoubleStockTransfer(manager, module);
}

// --------------------------------------------------------------------------------------------
BOOST_AUTO_TEST_CASE(Ublas_DoubleStockAndApplyTransfer) {
...
// --------------------------------------------------------------------------------------------
BOOST_AUTO_TEST_CASE(Ublas_SubmitOperationAddsToPendingQueue) {
	SubmitOperationAddsToPendingQueue(manager, module);
}

// --------------------------------------------------------------------------------------------
BOOST_AUTO_TEST_CASE(Ublas_ClearLastAppliedOperationResults) {
...
// --------------------------------------------------------------------------------------------
BOOST_AUTO_TEST_CASE(Ublas_ApplyAndGetOperationsLastApplied) {
	ApplyAndGetOperationsLastApplied(manager, module);
}

// --------------------------------------------------------------------------------------------
BOOST_AUTO_TEST_CASE(Ublas_ApplyOperationsClearsPendingQueue) {
