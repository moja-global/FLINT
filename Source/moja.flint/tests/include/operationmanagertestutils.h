...
struct UtilsClass {
	...
	MockOperationBundle createOperation() {
		...
		auto operationResultFluxCollection = std::make_shared<mocks::MockOperationResultFluxCollection>(operationResultFluxIterator);
		...
		return MockOperationBundle{ operationManager, operation, operationResult, operationResultFlux, operationResultFluxIterator, operationResultFluxCollection };
	}
};
