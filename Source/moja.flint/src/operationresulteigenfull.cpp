...
OperationTransferType OperationResultEigenFull::transferType() const { return _transferType; }

const ModuleMetaData* OperationResultEigenFull::metaData() const { return _metaData; }

const DynamicVar& OperationResultEigenFull::dataPackage() const { return _dataPackage; }

bool OperationResultEigenFull::hasDataPackage() const { return _hasDataPackage; }
