...
OperationTransferType OperationResultSimple::transferType() const {
...
const ModuleMetaData* OperationResultSimple::metaData() const {
	return _metaData;
}

// --------------------------------------------------------------------------------------------

const DynamicVar& OperationResultSimple::dataPackage() const {
	return _dataPackage;
}

// --------------------------------------------------------------------------------------------

bool OperationResultSimple::hasDataPackage() const {
