...
OperationTransferType OperationResultSimpleCache::transferType() const { return _transferType; }
...
const ModuleMetaData* OperationResultSimpleCache::metaData() const { return _metaData; }

const DynamicVar& OperationResultSimpleCache::dataPackage() const { return _dataPackage; }

bool OperationResultSimpleCache::hasDataPackage() const { return _hasDataPackage; }
