...
// --------------------------------------------------------------------------------------------
StockOperationSimpleCache::StockOperationSimpleCache(OperationManagerSimpleCache* manager, std::vector<double>& pools,
...
StockOperationSimpleCache* StockOperationSimpleCache::addTransfer(const IPool* source, const IPool* sink,
                                                                  double value) {
   // MOJA_LOG_DEBUG << "SimpleCache Transfer (stck) - src: " << source->idx() << ", snk: " << sink->idx() << ", value:"
   // << value;
...
OperationTransferType StockOperationSimpleCache::transferType() const { return OperationTransferType::Stock; }

// --------------------------------------------------------------------------------------------

void StockOperationSimpleCache::submitOperation() { _manager->submitOperation(this); }
