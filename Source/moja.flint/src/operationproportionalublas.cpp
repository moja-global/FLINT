...
// ProportionalOperationUblas* ProportionalOperationUblas::addTransfer(const IPool* source, const IPool* sink, double
// value) { 	_matrix(source->idx(), sink->idx()) += value; 	_hasChange = true; 	return this;
//}
