...
SpinupLandUnitController::SpinupLandUnitController(LandUnitController& landUnitController) : _landUnitController(landUnitController), _config(nullptr) {}
...
std::shared_ptr<IOperation> SpinupLandUnitController::createProportionalOperation(IModule& module, DynamicVar& dataPackage) {
...
void SpinupLandUnitController::applyOperations() {
	_landUnitController.applyOperations();
}
...
void SpinupLandUnitController::clearAllOperationResults() {
...
void SpinupLandUnitController::initialisePools() const {
	_landUnitController.initialisePools();
}
...
ITiming& SpinupLandUnitController::timing() {
	return _timing;
}

IOperationManager* SpinupLandUnitController::operationManager()	{
...
const ITiming& SpinupLandUnitController::timing() const {
	return _timing;
}
