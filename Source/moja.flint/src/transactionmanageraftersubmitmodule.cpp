...
void TransactionManagerAfterSubmitModule::subscribe(NotificationCenter& notificationCenter) {
   ...
   notificationCenter.subscribe(signals::PostNotification, &TransactionManagerAfterSubmitModule::onPostNotification,
                                *this);
}
...
void TransactionManagerAfterSubmitModule::onPostNotification(short) { _landUnitData->applyOperations(); }
