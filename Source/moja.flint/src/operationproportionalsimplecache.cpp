...
ProportionalOperationSimpleCache::ProportionalOperationSimpleCache(OperationManagerSimpleCache* manager,
                                                                   std::vector<double>& pools, double timeScale,
...
ProportionalOperationSimpleCache* ProportionalOperationSimpleCache::addTransfer(const IPool* source, const IPool* sink,
                                                                                double value) {
   // MOJA_LOG_DEBUG << "SimpleCache Transfer (prop) - src: " << source->idx() << ", snk: " << sink->idx() << ", value:"
   // << value;
...
std::shared_ptr<IOperationResult> ProportionalOperationSimpleCache::computeOperation(ITiming& _timing) {
   ...
   // MOJA_LOG_DEBUG << "SimpleCache computeOperation (prop) - pools: " << boost::join(_pools |
...
// --------------------------------------------------------------------------------------------
void ProportionalOperationSimpleCache::submitOperation() { _manager->submitOperation(this); }
