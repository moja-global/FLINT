...
OperationTransferType OperationResultUblas::transferType() const { return _transferType; }

const ModuleMetaData* OperationResultUblas::metaData() const { return _metaData; }

const DynamicVar& OperationResultUblas::dataPackage() const { return _dataPackage; }

bool OperationResultUblas::hasDataPackage() const { return _hasDataPackage; }
