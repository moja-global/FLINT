...
void LandUnitController::submitOperation(std::shared_ptr<IOperation> operation) {
	operation->submitOperation();
}

void LandUnitController::applyOperations() {
	_operationManager->applyOperations();
}

void LandUnitController::clearLastAppliedOperationResults() {
	_operationManager->clearLastAppliedOperationResults();
}

void LandUnitController::clearAllOperationResults() {
	_operationManager->clearAllOperationResults();
}
...
void LandUnitController::initialisePools() const {
	_operationManager->initialisePools();
}
...
ITiming& LandUnitController::timing() {
	return _timing;
}

const ITiming& LandUnitController::timing() const {
	return _timing;
}
