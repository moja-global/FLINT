...
VariableAndPoolStringBuilder::VariableAndPoolStringBuilder(const flint::ILandUnitController& landUnitController,
                                                           const std::string& workingStr)
    : _landUnitController(nullptr), _landUnitDataWrapper(nullptr) {
   configure(landUnitController, workingStr);
}

VariableAndPoolStringBuilder::VariableAndPoolStringBuilder(const flint::ILandUnitDataWrapper* landUnitWrapper,
                                                           const std::string& workingStr)
    : _landUnitController(nullptr), _landUnitDataWrapper(nullptr) {
   configure(landUnitWrapper, workingStr);
}

void VariableAndPoolStringBuilder::configure(const flint::ILandUnitController& landUnitController,
                                             const std::string& workingStr) {
...
void VariableAndPoolStringBuilder::configure(const flint::ILandUnitDataWrapper* landUnitWrapper,
                                             const std::string& workingStr) {
...
std::vector<std::string> VariableAndPoolStringBuilder::extractTokens(const std::string& tokenType,
...
void VariableAndPoolStringBuilder::replaceTokens(const std::string& tokenType, std::string& query,
...
std::string VariableAndPoolStringBuilder::formatVariableValues(const flint::IVariable& var,
