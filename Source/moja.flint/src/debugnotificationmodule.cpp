...
void DebugNotificationModule::subscribe(NotificationCenter& notificationCenter) {
	...
	notificationCenter.subscribe(signals::LocalDomainProcessingUnitInit,		&DebugNotificationModule::onLocalDomainProcessingUnitInit,		*this);
	notificationCenter.subscribe(signals::LocalDomainProcessingUnitShutdown,	&DebugNotificationModule::onLocalDomainProcessingUnitShutdown,	*this);
...
void DebugNotificationModule::onSystemInit() {
	MOJA_LOG_DEBUG << _localDomainId;
}

void DebugNotificationModule::onSystemShutdown() {
	MOJA_LOG_DEBUG << _localDomainId;
}

void DebugNotificationModule::onLocalDomainInit() {
	MOJA_LOG_DEBUG << _localDomainId;
}

void DebugNotificationModule::onLocalDomainShutdown() {
	MOJA_LOG_DEBUG << _localDomainId;
}

void DebugNotificationModule::onLocalDomainProcessingUnitInit() {
	MOJA_LOG_DEBUG << _localDomainId;
}

void DebugNotificationModule::onLocalDomainProcessingUnitShutdown() {
	MOJA_LOG_DEBUG << _localDomainId;
}

void DebugNotificationModule::onPreTimingSequence() {
	MOJA_LOG_DEBUG << _localDomainId;
}

void DebugNotificationModule::onTimingInit() {
	MOJA_LOG_DEBUG << _localDomainId;
}

void DebugNotificationModule::onTimingPostInit() {
	MOJA_LOG_DEBUG << _localDomainId;
}

void DebugNotificationModule::onTimingShutdown() {
	MOJA_LOG_DEBUG << _localDomainId;
}

void DebugNotificationModule::onTimingStep() {
	MOJA_LOG_DEBUG << _localDomainId;
}

void DebugNotificationModule::onTimingPreEndStep() {
	MOJA_LOG_DEBUG << _localDomainId;
}

void DebugNotificationModule::onTimingEndStep() {
	MOJA_LOG_DEBUG << _localDomainId;
}

void DebugNotificationModule::onTimingPostStep() {
	MOJA_LOG_DEBUG << _localDomainId;
}

void DebugNotificationModule::onOutputStep() {
	MOJA_LOG_DEBUG << _localDomainId;
}

void DebugNotificationModule::onError(std::string msg) {
	MOJA_LOG_DEBUG << _localDomainId;
}

void DebugNotificationModule::onDisturbanceEvent(DynamicVar) {
	MOJA_LOG_DEBUG << _localDomainId;
}

void DebugNotificationModule::onPostDisturbanceEvent() {
	MOJA_LOG_DEBUG << _localDomainId;
}
