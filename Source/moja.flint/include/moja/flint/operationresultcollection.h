...
inline OperationResultCollection::iterator OperationResultCollection::begin() { return _vec.begin(); }

inline OperationResultCollection::const_iterator OperationResultCollection::begin() const MOJA_NOEXCEPT {
   return _vec.begin();
}

inline OperationResultCollection::iterator OperationResultCollection::end() MOJA_NOEXCEPT { return _vec.end(); }

inline OperationResultCollection::const_iterator OperationResultCollection::end() const MOJA_NOEXCEPT {
   return _vec.end();
}

inline void OperationResultCollection::clear() { _vec.clear(); }

inline OperationResultCollection::size_type OperationResultCollection::size() const MOJA_NOEXCEPT {
   return _vec.size();
}

inline void OperationResultCollection::push_back(const_reference operationResult) { _vec.push_back(operationResult); }

inline void OperationResultCollection::push_back(value_type&& operationResult) { _vec.push_back(operationResult); }
