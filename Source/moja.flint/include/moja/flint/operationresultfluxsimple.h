...
public:
	...
	OperationResultFluxSimple(OperationTransferType transferType, const ModuleMetaData* metaData, int source, int sink, double value);
...
inline OperationResultFluxSimple::OperationResultFluxSimple(OperationTransferType transferType, const ModuleMetaData* metaData, int source, int sink, double value)
