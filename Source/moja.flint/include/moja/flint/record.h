...
public:
	explicit PoolInfoRecord(const std::string& name, const std::string& desc, int idx, int order, double scale, const std::string& units);
...
public:
	FluxRecord(bool doAggregation, int localdomainId, Int64 dateId, Poco::Nullable<Int64> moduleInfoId, Int64 itemCount, int srcPoolInfoId, int sinkPoolInfoId, double flux);
	~FluxRecord() {}
