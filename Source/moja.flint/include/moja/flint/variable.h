...
class Variable : public IVariable {
  public:
   ...
   inline const VariableInfo& info() const override { return _info; }

   inline const DynamicVar& value() const override { return _value; }
   ...
   inline bool isExternal() const override { return false; }

   inline bool isFlintData() const override { return false; }
