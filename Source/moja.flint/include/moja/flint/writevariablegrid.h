   ...
   class DataSettingsB {
     public:
      ...
      virtual void doLocalDomainProcessingUnitShutdown(
          std::shared_ptr<const SpatialLocationInfo> spatialLocationInfo) = 0;
     ...
     protected:
      ...
      int _hdrDataType;  // ENVI Data type (from:
                         // https://opticks.org/docs/help/4.9.1/Help/Opticks/Content/Importers_Exporters/ENVI_Header_Format.htm)
