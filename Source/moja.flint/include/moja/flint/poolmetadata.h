...
public:
	PoolMetaData()
		: _name(""), _description(""), _units(""), _scale(1.0), _order(-1) {}

	PoolMetaData(const std::string& name, const std::string& description, const std::string& units, double scale, int order)
