...
#define BOOST_UBLAS_NDEBUG	// cuts some time off run (http://www.boost.org/doc/libs/1_49_0/libs/numeric/ublas/doc/index.htm)
...
#define MOJA_UBLAS_MAKE_I(i, s) { i = moja_ublas_identity(s); }
