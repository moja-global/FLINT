...
class OperationResultFluxSimpleCache : public IOperationResultFlux {
  public:
   ...
   OperationResultFluxSimpleCache(OperationTransferType transferType, const ModuleMetaData* metaData, int source,
...
inline OperationResultFluxSimpleCache::OperationResultFluxSimpleCache(OperationTransferType transferType,
