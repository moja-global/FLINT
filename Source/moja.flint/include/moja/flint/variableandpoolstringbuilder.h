...
class FLINT_API VariableAndPoolStringBuilder {
  public:
   ...
   VariableAndPoolStringBuilder(const flint::ILandUnitController& landUnitController, const std::string& workingStr);

   VariableAndPoolStringBuilder(const flint::ILandUnitDataWrapper* landUnitWrapper, const std::string& workingStr);

   void configure(const flint::ILandUnitController& landUnitController, const std::string& workingStr);
   void configure(const flint::ILandUnitDataWrapper* landUnitWrapper, const std::string& workingStr);
