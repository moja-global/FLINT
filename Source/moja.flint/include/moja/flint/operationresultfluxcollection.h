...
public:
	...
	explicit OperationResultFluxCollection(std::shared_ptr<IOperationResultFluxIterator> it) :_collectionBaseIterator(it) {}
...
OperationResultFluxCollection::_iterator<is_const_iterator>::_iterator(std::shared_ptr<IOperationResultFluxIterator> it, bool atEnd)
	: _iteratorBase(it) {
}

template <bool is_const_iterator>
inline typename OperationResultFluxCollection::_iterator<is_const_iterator>::self_type& OperationResultFluxCollection::_iterator<is_const_iterator>::operator++() {
	increment();
	return *this;
}

template <bool is_const_iterator>
inline typename OperationResultFluxCollection::_iterator<is_const_iterator>::self_type OperationResultFluxCollection::_iterator<is_const_iterator>::operator++(int) {
...
template <bool is_const_iterator>
inline typename OperationResultFluxCollection::_iterator<is_const_iterator>::ValueType OperationResultFluxCollection::_iterator<is_const_iterator>::operator*() {
